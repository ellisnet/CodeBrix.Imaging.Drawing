...
using NoSkiaSession = noskia::CodeBrix.Imaging.Drawing.DrawingSession;

namespace CodeBrix.Imaging.Drawing.ParityTests;

/// <summary>
/// The <see cref="ISessionAdapter"/> over the fully managed CodeBrix.Imaging.Drawing.NoSkia
/// library (referenced under the <c>noskia</c> extern alias).
/// </summary>
internal sealed class NoSkiaSessionAdapter : ISessionAdapter
{
    private readonly NoSkiaSession _session = new NoSkiaSession();

    /// <inheritdoc />
    public string BackendName => "NoSkia";
