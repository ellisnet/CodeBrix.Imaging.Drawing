...
This repository publishes TWO packages that are EITHER/OR alternatives - they
...
------------------------------------------------------------------
  ...
  AGENT-README-NOSKIA.txt
      CodeBrix.Imaging.Drawing.NoSkia.ApacheLicenseForever — the same
      drawing-session API with zero native dependencies, plus a
      SkiaSharp-workalike managed drawing engine and a managed SVG renderer.
