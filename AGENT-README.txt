...
- Dependencies: SkiaSharp (4.151.0 or later) and
...
5. Canvas wiring per head (the part to copy into a new app): every head
   ...
   SkiaSharp.Views.MitLicenseForever 4.151.0 and SkiaSharp.Views.WinUI
   4.151.0 respectively) and to SkiaSharp.Views.WPF.SKElement on native
   WPF (4.151.0). The XAML is just <drawing:DrawingCanvas x:Name=
