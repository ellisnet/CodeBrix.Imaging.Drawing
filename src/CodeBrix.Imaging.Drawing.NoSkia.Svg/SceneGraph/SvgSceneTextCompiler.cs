...
internal static class SvgSceneTextCompiler
{
    ...
    private static SvgTextBase CreateAnchorTextStyleSource(SvgAnchor svgAnchor)
    {
        ...
        // Vendoring change: SvgElement._parent is internal to CodeBrix.SvgParse
        // (InternalsVisibleTo covers only the original CodeBrix.SkiaSvg assembly), so the
        // field is set through the reflection shim in SvgParseInternalsShim.cs instead.
        SvgParseInternals.SetParent(scopedStyleSource, svgAnchor);
