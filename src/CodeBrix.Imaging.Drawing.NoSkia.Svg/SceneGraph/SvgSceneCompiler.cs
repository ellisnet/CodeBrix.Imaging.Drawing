...
// </summary>
internal static class SvgSceneCompiler
{
    ...
    {
        // Vendoring change: SvgElement.WithTemporaryParent is internal to CodeBrix.SvgParse
        // (InternalsVisibleTo covers only the original CodeBrix.SkiaSvg assembly), so the
        // equivalent reflection-based shim in SvgParseInternalsShim.cs is used instead.
        return SvgParseInternals.WithTemporaryParent(element, temporaryParent, factory);
    }
