...
internal abstract record SKImageFilter : IDeepCloneable<SKImageFilter>
{
...
internal record ArithmeticImageFilter(float K1, float K2, float K3, float K4, bool EforcePMColor, SKImageFilter Background, SKImageFilter Foreground, SKRect? Clip) : SKImageFilter;
...
// <param name="Foreground">The foreground image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record BlendModeImageFilter(SKBlendMode Mode, SKImageFilter Background, SKImageFilter Foreground, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record BlurImageFilter(float SigmaX, float SigmaY, SKImageFilter Input, SKRect? Clip) : SKImageFilter;

// <summary>An image filter that applies a color filter.</summary>
// <param name="ColorFilter">The color filter to apply.</param>
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record ColorFilterImageFilter(SKColorFilter ColorFilter, SKImageFilter Input, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record DilateImageFilter(int RadiusX, int RadiusY, SKImageFilter Input, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record DisplacementMapEffectImageFilter(SKColorChannel XChannelSelector, SKColorChannel YChannelSelector, float Scale, SKImageFilter Displacement, SKImageFilter Input, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record DistantLitDiffuseImageFilter(SKPoint3 Direction, SKColor LightColor, float SurfaceScale, float Kd, SKImageFilter Input, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record DistantLitSpecularImageFilter(SKPoint3 Direction, SKColor LightColor, float SurfaceScale, float Ks, float Shininess, SKImageFilter Input, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record ErodeImageFilter(int RadiusX, int RadiusY, SKImageFilter Input, SKRect? Clip) : SKImageFilter;
...
// <param name="Dst">The destination rectangle.</param>
// <param name="FilterQuality">The filter quality for image sampling.</param>
internal record ImageImageFilter(SKImage Image, SKRect Src, SKRect Dst, SKFilterQuality FilterQuality) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record MatrixConvolutionImageFilter(SKSizeI KernelSize, float[] Kernel, float Gain, float Bias, SKPointI KernelOffset, SKShaderTileMode TileMode, bool ConvolveAlpha, SKImageFilter Input, SKRect? Clip) : SKImageFilter;

// <summary>An image filter that merges multiple image filters.</summary>
// <param name="Filters">The image filters to merge.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record MergeImageFilter(SKImageFilter[] Filters, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record OffsetImageFilter(float Dx, float Dy, SKImageFilter Input, SKRect? Clip) : SKImageFilter;

// <summary>An image filter that draws using a paint object.</summary>
// <param name="Paint">The paint to draw with.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record PaintImageFilter(SKPaint Paint, SKRect? Clip) : SKImageFilter;

// <summary>An image filter that draws using a shader.</summary>
// <param name="Shader">The shader to draw with.</param>
// <param name="Dither">Whether to apply dithering.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record ShaderImageFilter(SKShader Shader, bool Dither, SKRect? Clip) : SKImageFilter;

// <summary>An image filter created from a recorded picture.</summary>
// <param name="Picture">The source picture.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record PictureImageFilter(SKPicture Picture, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record PointLitDiffuseImageFilter(SKPoint3 Location, SKColor LightColor, float SurfaceScale, float Kd, SKImageFilter Input, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record PointLitSpecularImageFilter(SKPoint3 Location, SKColor LightColor, float SurfaceScale, float Ks, float Shininess, SKImageFilter Input, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record SpotLitDiffuseImageFilter(SKPoint3 Location, SKPoint3 Target, float SpecularExponent, float CutoffAngle, SKColor LightColor, float SurfaceScale, float Kd, SKImageFilter Input, SKRect? Clip) : SKImageFilter;
...
// <param name="Input">The input image filter.</param>
// <param name="Clip">The optional clip rectangle.</param>
internal record SpotLitSpecularImageFilter(SKPoint3 Location, SKPoint3 Target, float SpecularExponent, float CutoffAngle, SKColor LightColor, float SurfaceScale, float Ks, float Shininess, SKImageFilter Input, SKRect? Clip) : SKImageFilter;

// <summary>An image filter that tiles the input within a destination rectangle.</summary>
// <param name="Src">The source rectangle.</param>
// <param name="Dst">The destination rectangle.</param>
// <param name="Input">The input image filter.</param>
internal record TileImageFilter(SKRect Src, SKRect Dst, SKImageFilter Input) : SKImageFilter;
