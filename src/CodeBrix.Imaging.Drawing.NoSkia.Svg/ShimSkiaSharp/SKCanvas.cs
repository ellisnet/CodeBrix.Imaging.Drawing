...
internal abstract record CanvasCommand : IDeepCloneable<CanvasCommand>
{
    // <inheritdoc />
...
internal record ClipPathCanvasCommand(ClipPath ClipPath, SKClipOperation Operation, bool Antialias) : CanvasCommand;

// <summary>A canvas command that clips drawing to a rectangle.</summary>
// <param name="Rect">The clip rectangle.</param>
// <param name="Operation">The clip operation.</param>
// <param name="Antialias">Whether to apply antialiasing to the clip.</param>
internal record ClipRectCanvasCommand(SKRect Rect, SKClipOperation Operation, bool Antialias) : CanvasCommand;
...
internal record DrawImageCanvasCommand(SKImage Image, SKRect Source, SKRect Dest, SKPaint Paint = null) : CanvasCommand;

// <summary>A canvas command that draws a recorded picture.</summary>
// <param name="Picture">The picture to draw.</param>
internal record DrawPictureCanvasCommand(SKPicture Picture) : CanvasCommand;

// <summary>A canvas command that draws a path with paint.</summary>
// <param name="Path">The path to draw.</param>
// <param name="Paint">The paint to use for drawing.</param>
internal record DrawPathCanvasCommand(SKPath Path, SKPaint Paint) : CanvasCommand;
...
// <param name="Paint">The paint to use for drawing.</param>
internal record DrawTextBlobCanvasCommand(SKTextBlob TextBlob, float X, float Y, SKPaint Paint) : CanvasCommand;
...
// <param name="Y">The Y coordinate for the text origin.</param>
// <param name="Paint">The paint to use for drawing.</param>
internal record DrawTextCanvasCommand(string Text, float X, float Y, SKPaint Paint) : CanvasCommand;
...
// <param name="Paint">The paint to use for drawing.</param>
internal record DrawTextOnPathCanvasCommand(string Text, SKPath Path, float HOffset, float VOffset, SKPaint Paint) : CanvasCommand;

// <summary>A canvas command that restores the canvas state.</summary>
// <param name="Count">The save count after the restore.</param>
internal record RestoreCanvasCommand(int Count) : CanvasCommand;

// <summary>A canvas command that saves the canvas state.</summary>
// <param name="Count">The save count at the time of saving.</param>
internal record SaveCanvasCommand(int Count) : CanvasCommand;
...
internal record SaveLayerCanvasCommand(int Count, SKPaint Paint = null) : CanvasCommand;
...
internal record SetMatrixCanvasCommand(SKMatrix DeltaMatrix, SKMatrix TotalMatrix) : CanvasCommand;

// <summary>Represents a recording canvas that captures drawing commands.</summary>
internal class SKCanvas : ICloneable, IDeepCloneable<SKCanvas>
{
