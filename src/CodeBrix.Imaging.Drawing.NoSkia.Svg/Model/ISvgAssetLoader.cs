...
internal record struct TypefaceSpan(string Text, float Advance, SKTypeface Typeface);
...
internal readonly record struct ShapedGlyphRun(ushort[] Glyphs, SKPoint[] Points, int[] Clusters, float Advance);

// <summary>Provides asset loading services for SVG rendering.</summary>
internal interface ISvgAssetLoader
{
...
internal interface ISvgTextReferenceRenderingOptions
{
...
internal interface ISvgTextRunTypefaceResolver
{
...
internal interface ISvgTextGlyphRunResolver
{
...
internal interface ISvgTextDirectedGlyphRunResolver
{
